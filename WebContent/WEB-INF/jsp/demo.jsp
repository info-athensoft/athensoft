    ...
    <div class="container marketing">
      ...
      <div class="row">
		...
		<div class="row">
			<div class="col-lg-4">
	         <a href="#">
	          <img class="img-responsive" src="content/img/demo/1/port1.jpg" alt="Generic placeholder image">
	         </a>
	          <h4><a href="#">Portfolio 1</a></h4>
	        </div><!-- /.col-lg-4 -->
	        <div class="col-lg-4">
	         <a href="#">
	          <img class="img-responsive" src="content/img/demo/1/port2.jpg" alt="Generic placeholder image">
	         </a>
	          <h4><a href="#">Portfolio 2</a></h4>
	        </div><!-- /.col-lg-4 -->
	        <div class="col-lg-4">
	         <a href="#">
	          <img class="img-responsive" src="content/img/demo/1/port3.jpg" alt="Generic placeholder image">
	         </a>
	          <h4><a href="#">Portfolio 3</a></h4>
	        </div><!-- /.col-lg-4 -->
		</div>
		
		<div class="row">
			<div class="col-lg-4">
	         <a href="${url_server}${url_app}index-shop.jsp">
	          <img class="img-responsive" src="content/img/demo/1/ecomm1.jpg" alt="Generic placeholder image">
	         </a>
	          <h4><a href="${url_server}${url_app}index-shop.jsp">E-Commerce 1</a></h4>
	        </div><!-- /.col-lg-4 -->
	        <div class="col-lg-4">
	         <a href="${url_server}${url_app}index-shop-2.jsp">
	          <img class="img-responsive" src="content/img/demo/1/ecomm2.jpg" alt="Generic placeholder image">
	         </a>
	          <h4><a href="${url_server}${url_app}index-shop-2.jsp">E-Commerce 2</a></h4>
	        </div><!-- /.col-lg-4 -->
		</div>	
     </div>
