    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <a href="${url_server}${url_app}index-corporate.jsp" target="_blank">
          <img class="img-responsive" src="content/img/demo/2/demo1.png" alt="Generic placeholder image">
          </a>
        ...
        <a href="${url_server}${url_app}index-corporate-1.jsp" target="_blank">
          <img class="img-responsive" src="content/img/demo/2/demo2.png" alt="Generic placeholder image">
        </a>
        ...
        <div class="col-lg-4">
         <a href="${url_server}${url_app}index-corporate-2.jsp" target="_blank">
          <img class="img-responsive" src="content/img/demo/2/demo3.png" alt="Generic placeholder image">
         </a>
		...
		<div  class="row">
			<div class="col-lg-4">
	         <a href="${url_server}${url_app}index-corporate-3.jsp" target="_blank">
	          <img class="img-responsive" src="content/img/demo/2/demo4.png" alt="Generic placeholder image">
	         </a>
